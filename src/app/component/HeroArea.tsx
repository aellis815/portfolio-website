            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 mt-24">
                <div className="col-span-7 place-self-center text-center sm:text-left">
                    <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
                        <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#0096FF] to-[#FCBF49]">Hey, I&apos;m{" "}
                        </span>
                    ...
                    <div>
                        <button className="
                            ...
                            rounded-full 
                            mt-3 
                            bg-gradient-to-br from-[#0096FF] to-[#FCBF49] hover:bg-white text-white mr-4">
                            Contact Me
                        </button>
                ...
                <div className="col-span-5 place-self-center mt-4 lg:mt-0 ml-6">
                    <div className="rounded-full bg-gradient-to-br from-[#0096FF] via-[#0B666A] to-[#FCBF49] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative m-5">
                        <Image
